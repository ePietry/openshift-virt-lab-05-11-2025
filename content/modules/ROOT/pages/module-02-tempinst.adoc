...
+
image::2025_spring/module-07-tempinst/24_Windows_2k19_Provisioning[link=self, window=blank, width=100%]
...
+
image::2025_spring/module-07-tempinst/25_CD_Import[link=self, window=blank, width=100%]
...
+
image::2025_spring/module-07-tempinst/26_Windows_2k19_Console[link=self, window=blank, width=100%]
