...
Cette section montre simplement comment vous procéderiez pour installer Kasten s'il n'était pas déjà installé sur le *cluster OpenShift*.
====
...
+
image::2025_spring/kasten/7.png[link=self, window=blank, width=100%]
