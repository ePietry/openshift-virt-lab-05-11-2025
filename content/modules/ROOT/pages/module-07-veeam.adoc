...
. Une nouvelle fenêtre s'ouvrira avec le tableau de bord Kasten K10. Vous pouvez desormais vous identifiez avec vos logins OpenShift.
+
image::2025_spring/kasten/4.png[link=self, window=blank, width=100%]

. Si nécessaire, autorisez l'access à Kasten à votre nom d'utilisateur
+
...
. Dans le tableau de bord selectionez le menu à trois points de notre *projet-X* et cliquez sur *Create a policy*
+
...
. Remplissez le formulaire pour notre politique de sauvegarde :
    * *Name:* Nous pouvons le laissez par default
    * *Backup Frequency:* *Daily*
    * Selectionnez *Enable Backups via Snapshot Exports* et selectionnez le stockage *s3-odf*
    * Laissez les autres options par défaut et cliquez sur *Submit*
+
image::2025_spring/kasten/10.png[link=self, window=blank, width=100%]

. Cliquez sur *Create Policy*.

. La politique est maintenant créée, mais elle n'a pas encore été exécutée. Sur la ligne de votre nouvelle politique (`projet-x-backup`), cliquez sur l'icône a droite puis sur *Run Once*.
+
