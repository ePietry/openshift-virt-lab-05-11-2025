...
image::module-01/plus.png[link=self, window=blank, width=30%]

. Past this YAML manifest and click on *Create*
...
* Username: 'ocpvirt-dlqxp@infra'
* Password: 't256.DWHSmwoM8'
* Skip certificate validation: 'check skip'

image::module-01/provider.png[link=self, window=blank, width=30%]
