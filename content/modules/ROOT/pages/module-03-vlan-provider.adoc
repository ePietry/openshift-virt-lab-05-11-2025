...
+
image::2025_spring/module-09-networking/23.png[link=self, window=blank, width=100%]
...
+
image::2025_spring/module-09-networking/24.png[link=self, window=blank, width=100%]
