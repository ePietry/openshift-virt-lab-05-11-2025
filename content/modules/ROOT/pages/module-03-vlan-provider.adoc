...
+
image::2025_spring/module-09-networking/26.png[link=self, window=blank, width=75%]
+
...
+
image::2025_spring/module-09-networking/27.png[link=self, window=blank, width=75%]
+
