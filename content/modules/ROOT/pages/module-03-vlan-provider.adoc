...
+
image::2025_spring/module-09-networking/34.png[link=self, window=blank, width=100%]
+
...
image::2025_spring/module-09-networking/35.png[link=self, window=blank, width=100%]
...
+
image::2025_spring/module-09-networking/29.png[link=self, window=blank, width=50%]
+
