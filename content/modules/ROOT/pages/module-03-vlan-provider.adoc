...
Cependant, la connexion au `corp-network`, définie par la NAD, est une connexion directe au bridge Linux (`br-flat`) qui existe sur *tous* les nœuds workers. L'IP de la VM est attribuée par un mechanisme externe au cluster.
