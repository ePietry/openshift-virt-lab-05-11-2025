...
Pensez à la NAD comme un NIC virtuel. C'est une ressource limitée à un espace de Projet qui définit un type de NIC pourant etre consomé par nos VMs. Il servira de lien entre nos VMs et notre Bridge br-flat.
