...
Dans cette première partie, nous allons prendre en main la plateforme en créant des VMs Linux et Windows et en effectuant nos premières actions d'administration.
