...
. Nous retournerons à notre vue en arborescence et il est possible de voir les informations sur notre nouvelle VM dans la colonne d'aperçu des machines virtuelles. Remarquez aussi que nous voyons maintenant notre *project* *project-X* listé dans la colonne de droite car il contient désormais une VM.
+
