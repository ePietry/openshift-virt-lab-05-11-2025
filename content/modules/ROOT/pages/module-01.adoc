...
. Lors de votre première connexion, vous serez placé dans la *Administrator* persona, avec une invite d'introduction. Cliquez sur le bouton *Skip tour* pour fermer la fenêtre.
+
